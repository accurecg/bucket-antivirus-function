...
AV_EXPECTED_BUCKET_KEY_STATUS = os.getenv(
    "AV_EXPECTED_BUCKET_KEY_STATUS", "av-expected-key-status"
)
...
AV_SCAN_PASS_THROUGH_ENABLED = os.getenv("AV_SCAN_PASS_THROUGH_ENABLED", "False")
AV_SCAN_QUEUE_URL = os.getenv("AV_SCAN_QUEUE_URL")
